...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="#hero"><img class="w-100 h-100" src="{{asset('assets/img/logobonhcr.jpg')}}" alt=""></a></h1>
                ...
                <ul>
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <ul class="dropdown-menu">
                            <form method="POST" class="#" action="{{ route('logout') }}" role="search">
                                @csrf
                                @method('DELETE')
                    ...
                    <li><a class="getstarted scrollto" href="{{ route('loginadmin') }}">Espace Admin</a></li>
                </ul>
        ...
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 text-center">
                    <h1>Bienvenue sur Refugee Plateform</h1>
                    <h2>Vous pouvez faire une demande de Rénouvellement de votre Attestation de refugié en cliquant
                        juste sur le bouton ci-dessous
                    </h2>
                </div>
            </div>
            ...
            <div class="row icon-boxes">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Etre Refugié</a></h4>
                        <p class="description"> Vous devriez avant tout etre refugié</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Résider au Burkina Faso</a></h4>
                        <p class="description">Vous devriez résider au Burkina</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Avoir une attestation de refugié</a></h4>
                        <p class="description">Vous devriez disposer d'une attestation de réfugié </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Etre majeur</a></h4>
                        <p class="description">Vous devriez avoir un age supérieur ou égal a 16 ans</p>
                    </div>
                </div>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>A propos</h2>
                    <p>Refugee App est une plateforme dédiée uniquement aux personnes réfugiés vivant au Burkina Faso.
                    </p>
                </div>
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p>
                            Bienvenue sur Refugee APK, une plateforme dédiée à faciliter le processus de renouvellement
                            des attestations de réfugié.
                            Notre objectif est de simplifier les démarches administratives pour permettre aux réfugiés
                            de renouveler leurs documents en
                            toute simplicité.
                            Trois raisons pour utiliser cette plateforme:


                        </p>
                        <ul>
                            <li><i class="ri-check-double-line"></i> Faire votre demande de renouvellement ou que vous
                                soyez</li>
                            <li><i class="ri-check-double-line"></i> Evitez les "va et vient" inutilent</li>
                            <li><i class="ri-check-double-line"></i> Facilitez la tache au HCR et ses partenaires</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p>
                            Nous comprenons les défis auxquels font face les réfugiés dans leur quête de renouvellement
                            de documents.
                            Notre engagement est de fournir un environnement numérique convivial, sécurisé et accessible
                            pour accompagner ce processus.
                            <hr>
                            Notre mission est d'offrir une solution numérique pratique qui facilite l'accès aux services
                            essentiels pour les réfugiés.
                            En combinant technologie et engagement, nous aspirons à simplifier les complexités
                            bureaucratiques.
                            <hr>
                            Nous sommes solidaires des réfugiés et nous nous engageons à offrir un soutien continu tout
                            au long du processus de renouvellement.
                            Rejoignez-nous sur Refugee APK pour faire une différence positive dans la vie des réfugiés
                            en leur offrant une assistance fiable et efficace."
                        </p>
